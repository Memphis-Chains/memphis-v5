...
# Exclude data/embed-index-v1.json (contains documentation examples, not real secrets)
if grep -RInE --exclude-dir=node_modules --exclude-dir=.git --exclude='package-lock.json' --exclude='data/embed-index-v1.json' "$PATTERN" .; then
